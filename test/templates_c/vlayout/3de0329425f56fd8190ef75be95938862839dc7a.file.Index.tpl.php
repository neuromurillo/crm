<?php /* Smarty version Smarty-3.1.7, created on 2017-03-23 00:12:47
         compiled from "/home/ipao/public_html/crm/includes/runtime/../../layouts/vlayout/modules/Settings/CustomerPortal/Index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:199715581458d312ffd14716-05666893%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3de0329425f56fd8190ef75be95938862839dc7a' => 
    array (
      0 => '/home/ipao/public_html/crm/includes/runtime/../../layouts/vlayout/modules/Settings/CustomerPortal/Index.tpl',
      1 => 1410782148,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '199715581458d312ffd14716-05666893',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58d3130002b46',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58d3130002b46')) {function content_58d3130002b46($_smarty_tpl) {?>
...
</h3></div><hr><div class="contents row-fluid"><form id="customerPortalForm" class="form-horizontal"  method="POST"><div class="row-fluid"><div class="span6"><input type="hidden" name="portalModulesInfo" value="" /><div class="control-group"><label class="control-label"><?php echo vtranslate('LBL_PRIVILEGES',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</label><div class="controls"><span class="row-fluid"><select name="privileges" class="select2 span7"><?php  $_smarty_tpl->tpl_vars['USER_MODEL'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['USER_MODEL']->_loop = false;
...
</option><?php } ?></select></span></div></div><div class="control-group"><label class="control-label"><?php echo vtranslate('LBL_DEFAULT_ASSIGNEE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</label><div class="controls"><span class="row-fluid"><select name="defaultAssignee" class="select2 span7"><optgroup style="border: none" label="<?php echo vtranslate('LBL_USERS',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</option><?php } ?></optgroup></select></span></div></div><div class="control-group"><label class="control-label"><?php echo vtranslate('LBL_PORTAL_URL',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</label><div class="controls"><span class="help-inline"><a target="_blank" href="<?php echo $_smarty_tpl->tpl_vars['PORTAL_URL']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['PORTAL_URL']->value;?>
</a></span></div></div></div><div class="span6"><div class="alert alert-info"><p><?php echo vtranslate('LBL_PREVILEGES_MESSAGE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</p><p><?php echo vtranslate('LBL_DEFAULT_ASSIGNEE_MESSAGE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</p><p><?php echo vtranslate('LBL_PORTAL_URL_MESSAGE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</p></div></div></div><div class="row-fluid"><i class="icon-info-sign alignMiddle"></i>&nbsp;<?php echo vtranslate('LBL_DRAG_AND_DROP_MESSAGE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</div><br><div class="row-fluid"><table id="portalModulesTable" class="table table-bordered table-condensed themeTableColor"><thead><tr class="blockHeader"><th class="textAlignCenter"><?php echo vtranslate('LBL_MODULE_NAME',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</th><th class="textAlignCenter"><?php echo vtranslate('LBL_ENABLE_MODULE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</th><th class="textAlignCenter"><?php echo vtranslate('LBL_VIEW_ALL_RECORDS',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
" /><td><div class="row-fluid"><span class="span1"><a><img src="<?php echo vimage_path('drag.png');?>
" border="0" title="<?php echo vtranslate('LBL_DRAG',$_smarty_tpl->tpl_vars['MODULE']->value);?>
"/></a></span><span class="span11"><?php echo vtranslate($_smarty_tpl->tpl_vars['MODULE_NAME']->value,$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</span></div></td><td class="textAlignCenter"><input type="hidden" name="portalModulesInfo[<?php echo $_smarty_tpl->tpl_vars['TAB_ID']->value;?>
][visible]" value="0" /><input type="checkbox" name="portalModulesInfo[<?php echo $_smarty_tpl->tpl_vars['TAB_ID']->value;?>
][visible]" value="1" <?php if ($_smarty_tpl->tpl_vars['MODEL']->value->get('visible')=='1'){?> checked <?php }?>/></td><td class="textAlignCenter"><label class="radio inline"><input type="radio" name="portalModulesInfo[<?php echo $_smarty_tpl->tpl_vars['TAB_ID']->value;?>
